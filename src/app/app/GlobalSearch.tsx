                ...
                <Group title="Matches">
                  {results.matches.map((m) => (
                    <button
                      key={m.id}
                      type="button"
                      onClick={() => navigateAndClose(`/app/matches/${m.matchIdHelldock}`)}
                ...
                <Group title="Players">
                  {results.players.map((p) => (
                    <button
                      key={p.id}
                      type="button"
                      onClick={() => navigateAndClose(`/app/players/${encodeURIComponent(p.id)}`)}
              ...
              {results.opponents.length > 0 && (
                <Group title="Opponents">
                  {results.opponents.map((o) => (
                    <Link
                      key={o.name}
                      href={`/app/opponents/${encodeURIComponent(o.name)}`}
                      onClick={close}
